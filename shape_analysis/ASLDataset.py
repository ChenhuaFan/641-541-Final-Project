...
# Dataset created for procrustes analysis.
...
class ASLDataset(Dataset):
    ...
    def __init__(self, set_type, transform=None, target_transform=None, size_per_class=3000):
        ...
        classes = [chr(x) for x in range(ord('A'),ord('Z')+1)] + ['del', 'space','nothing']
    ...
    def __getitem__(self, idx):
        ...
        img_path = '../archive/asl_alphabet_train/asl_alphabet_train'
